...
class Config(object):
    ...
    CLIENT_SECRET = "xGK7Q~TGLalZsWP~jTDG8.cAI4GD.l3h8T1AA"
    ...
    CLIENT_ID = "61858a53-3d64-4b32-927a-3e9cd7b822ed"

    REDIRECT_PATH = "http://localhost:5555/get_a_token"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
