...
class Config(object):
    ...
    CLIENT_SECRET = "9Dz7Q~EJP9.InGKtp-qqg2T8u16IrJEX.mm0Q"
    ...
    REDIRECT_PATH = "http:127.0.0.1:500/get_a_token"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
