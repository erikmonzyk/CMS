...
class BlobClient(StorageAccountHostsMixin):  # pylint: disable=too-many-public-methods
    ...
    def from_blob_url(cls, blob_url, credential=None, snapshot=None, **kwargs):
        ...
        :rtype: ~azure.storage.blob.blob.BlobClient
        """
        try:
    ...
    def upload_blob_from_url(self, source_url, **kwargs):
        ...
        :paramtype destination_lease: ~azure.storage.blob.blob.BlobLeaseClient or str
        :keyword int timeout:
            The timeout parameter is expressed in seconds.
        :keyword ~azure.storage.blob.blob.ContentSettings content_settings:
            ContentSettings object used to set blob properties. Used to set content type, encoding,
            language, disposition, md5, and cache control.
        :keyword ~azure.storage.blob.blob.CustomerProvidedEncryptionKey cpk:
        ...
        :keyword ~azure.storage.blob.blob.StandardBlobTier standard_blob_tier:
    ...
    def upload_blob(  # pylint: disable=too-many-locals
        ...
        :param ~azure.storage.blob.blob.BlobType blob_type: The type of the blob. This can be
        ...
        :paramtype lease: ~azure.storage.blob.blob.BlobLeaseClient or str
        :keyword ~datetime.datetime if_modified_since:
            A DateTime value. Azure expects the date value passed in to be UTC.
            If timezone is included, any non-UTC datetimes will be converted to UTC.
            If a date is passed in without timezone info, it is assumed to be UTC.
        ...
        :keyword ~azure.storage.blob.blob.PremiumPageBlobTier premium_page_blob_tier:
        ...
        :keyword ~azure.storage.blob.blob.StandardBlobTier standard_blob_tier:
            A standard blob tier value to set the blob to. For this version of the library,
            this is only applicable to block blobs on standard storage accounts.
        :keyword ~azure.storage.blob.blob.ImmutabilityPolicy immutability_policy:
    ...
    def download_blob(self, offset=None, length=None, **kwargs):
        ...
        :rtype: ~azure.storage.blob.blob.StorageStreamDownloader
    ...
    def query_blob(self, query_expression, **kwargs):
        ...
        :keyword Callable[~azure.storage.blob.blob.BlobQueryError] on_error:
        ...
        :paramtype blob_format: ~azure.storage.blob.blob.DelimitedTextDialect or ~azure.storage.blob.blob.DelimitedJsonDialect
            or ~azure.storage.blob.blob.QuickQueryDialect or str
        :keyword output_format:
            ...
            These dialects can be passed through their respective classes, the QuickQueryDialect enum or as a string
        :paramtype output_format: ~azure.storage.blob.blob.DelimitedTextDialect or ~azure.storage.blob.blob.DelimitedJsonDialect
            or list[~azure.storage.blob.blob.ArrowDialect] or ~azure.storage.blob.blob.QuickQueryDialect or str
        :keyword lease:
        ...
        :rtype: ~azure.storage.blob.blob.BlobQueryReader
    ...
    def get_blob_properties(self, **kwargs):
        ...
        :rtype: ~azure.storage.blob.blob.BlobProperties
    ...
    def set_http_headers(self, content_settings=None, **kwargs):
        ...
        :param ~azure.storage.blob.blob.ContentSettings content_settings:
            ContentSettings object used to set blob properties. Used to set content type, encoding,
            language, disposition, md5, and cache control.
        :keyword lease:
            Required if the blob has an active lease. Value can be a BlobLeaseClient object
    ...
    def set_immutability_policy(self, immutability_policy, **kwargs):
        ...
        :param ~azure.storage.blob.blob.ImmutabilityPolicy immutability_policy:
            Specifies the immutability policy of a blob, blob snapshot or blob version.
    ...
    def create_page_blob(  # type: ignore
        ...
        :param metadata:
            Name-value pairs associated with the blob as metadata.
        :type metadata: dict(str, str)
        :param ~azure.storage.blob.blob.PremiumPageBlobTier premium_page_blob_tier:
            A page blob tier value to set the blob to. The tier correlates to the size of the
            blob and number of allowed IOPS. This is only applicable to page blobs on
            premium storage accounts.
        :keyword tags:
    ...
    def start_copy_from_url(self, source_url, metadata=None, incremental_copy=False, **kwargs):
        ...
        :paramtype source_lease: ~azure.storage.blob.blob.BlobLeaseClient or str
        :keyword int timeout:
            The timeout parameter is expressed in seconds.
        :keyword ~azure.storage.blob.blob.PremiumPageBlobTier premium_page_blob_tier:
            A page blob tier value to set the blob to. The tier correlates to the size of the
        ...
        :keyword ~azure.storage.blob.blob.StandardBlobTier standard_blob_tier:
            A standard blob tier value to set the blob to. For this version of the library,
            this is only applicable to block blobs on standard storage accounts.
        :keyword ~azure.storage.blob.blob.RehydratePriority rehydrate_priority:
    ...
    def abort_copy(self, copy_id, **kwargs):
        ...
        :type copy_id: str or ~azure.storage.blob.blob.BlobProperties
        :rtype: None
    ...
    def acquire_lease(self, lease_duration=-1, lease_id=None, **kwargs):
        ...
        :rtype: ~azure.storage.blob.blob.BlobLeaseClient
    ...
    def set_standard_blob_tier(self, standard_blob_tier, **kwargs):
        ...
        :type standard_blob_tier: str or ~azure.storage.blob.blob.StandardBlobTier
        :keyword ~azure.storage.blob.blob.RehydratePriority rehydrate_priority:
            Indicates the priority with which to rehydrate an archived blob
        :keyword str version_id:
            The version id parameter is an opaque DateTime
    ...
    def get_block_list(self, block_list_type="committed", **kwargs):
        ...
        :rtype: tuple(list(~azure.storage.blob.blob.BlobBlock), list(~azure.storage.blob.blob.BlobBlock))
        """
        access_conditions = get_access_conditions(kwargs.pop('lease', None))
        mod_conditions = get_modify_conditions(kwargs)
        try:
    ...
    def set_premium_page_blob_tier(self, premium_page_blob_tier, **kwargs):
        ...
        :param premium_page_blob_tier:
            ...
            blob and number of allowed IOPS. This is only applicable to page blobs on
            premium storage accounts.
        :type premium_page_blob_tier: ~azure.storage.blob.blob.PremiumPageBlobTier
        :keyword str if_tags_match_condition:
            Specify a SQL where clause on blob tags to operate only on blob with a matching value.
            eg. ``\"\\\"tagname\\\"='my tag'\"``
    ...
    def set_sequence_number(self, sequence_number_action, sequence_number=None, **kwargs):
        ...
        :param str sequence_number_action:
            ...
            number. See :class:`~azure.storage.blob.blob.SequenceNumberAction` for more information.
    ...
    def _get_container_client(self): # pylint: disable=client-method-missing-kwargs
        ...
        :rtype: ~azure.storage.blob.blob.ContainerClient
