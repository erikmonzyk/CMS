...
class BlobSharedAccessSignature(SharedAccessSignature):
    ...
    def __init__(self, account_name, account_key=None, user_delegation_key=None):
        ...
        :param ~azure.storage.blob.blob.models.UserDelegationKey user_delegation_key:
    ...
    def generate_blob(self, container_name, blob_name, snapshot=None, version_id=None, permission=None,
        ...
        :param str protocol:
            ...
            is https,http. See :class:`~azure.storage.blob.common.models.Protocol` for possible values.
...
def generate_account_sas(
    ...
    :type resource_types: str or ~azure.storage.blob.blob.ResourceTypes
    :param permission:
        The permissions associated with the shared access signature. The
        user is restricted to operations allowed by the permissions.
        Required unless an id is given referencing a stored access policy
        which contains this field. This field must be omitted if it has been
        specified in an associated stored access policy.
    :type permission: str or ~azure.storage.blob.blob.AccountSasPermissions
    :param expiry:
        The time at which the shared access signature becomes invalid.
        Required unless an id is given referencing a stored access policy
        which contains this field. This field must be omitted if it has
...
def generate_container_sas(
    ...
    :param ~azure.storage.blob.blob.UserDelegationKey user_delegation_key:
        Instead of an account shared key, the user could pass in a user delegation key.
        A user delegation key can be obtained from the service by authenticating with an AAD identity;
        this can be accomplished by calling :func:`~azure.storage.blob.blob.BlobServiceClient.get_user_delegation_key`.
...
def generate_blob_sas(
    ...
    :param permission:
        ...
        which contains this field. This field must be omitted if it has been
        specified in an associated stored access policy.
    :type permission: str or ~azure.storage.blob.blob.BlobSasPermissions
    :param expiry:
        The time at which the shared access signature becomes invalid.
        Required unless an id is given referencing a stored access policy
        which contains this field. This field must be omitted if it has
