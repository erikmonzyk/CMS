...
class BlobAnalyticsLogging(GeneratedLogging):
    ...
    :keyword ~azure.storage.blob.blob.RetentionPolicy retention_policy:
...
class ContainerProperties(DictMixin):
    ...
    :ivar str etag:
        ...
        conditionally.
    :ivar ~azure.storage.blob.blob.LeaseProperties lease:
    ...
    :ivar ~azure.storage.blob.blob.ContainerEncryptionScope encryption_scope:
...
class ContainerPropertiesPaged(PageIterator):
    ...
    :vartype current_page: list(~azure.storage.blob.blob.ContainerProperties)
...
class ImmutabilityPolicy(DictMixin):
    ...
    :keyword str or ~azure.storage.blob.blob.BlobImmutabilityPolicyMode policy_mode:
        Specifies the immutability policy mode to set on the blob.
...
class BlobProperties(DictMixin):
    ...
    :ivar ~azure.storage.blob.blob.CopyProperties copy:
        Stores all the copy properties for the blob.
    :ivar ~azure.storage.blob.blob.ContentSettings content_settings:
        Stores all the content settings for the blob.
    :ivar ~azure.storage.blob.blob.LeaseProperties lease:
        Stores all the lease information for the blob.
    :ivar ~azure.storage.blob.blob.StandardBlobTier blob_tier:
    ...
    :ivar list(~azure.storage.blob.blob.ObjectReplicationPolicy) object_replication_source_properties:
    ...
    :ivar ~azure.storage.blob.blob.ImmutabilityPolicy immutability_policy:
...
class AccessPolicy(GenAccessPolicy):
    ...
    :type permission: str or ~azure.storage.blob.blob.ContainerSasPermissions
    :param expiry:
...
class ContainerSasPermissions(object):
    ...
    :func:`~azure.storage.blob.blob.generate_container_sas` function and
    for the AccessPolicies used with
    :func:`~azure.storage.blob.blob.ContainerClient.set_container_access_policy`.
    ...
    def from_string(cls, permission):
        ...
        :rtype: ~azure.storage.blob.blob.ContainerSasPermissions
        """
...
class BlobSasPermissions(object):
    ...
    :func:`~azure.storage.blob.blob.generate_blob_sas` function.
    ...
    def from_string(cls, permission):
        ...
        :rtype: ~azure.storage.blob.blob.BlobSasPermissions
        """
        p_read = 'r' in permission
...
class ArrowDialect(ArrowField):
    ...
    :param ~azure.storage.blob.blob.ArrowType type: Arrow field type.
...
class ObjectReplicationPolicy(DictMixin):
    ...
    :ivar list(~azure.storage.blob.blob.ObjectReplicationRule) rules:
