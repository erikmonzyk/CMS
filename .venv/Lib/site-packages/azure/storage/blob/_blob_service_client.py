...
class BlobServiceClient(StorageAccountHostsMixin):
    ...
    def list_containers(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.storage.blob.blob.ContainerProperties]
    ...
    def find_blobs_by_tags(self, filter_expression, **kwargs):
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.storage.blob.blob.FilteredBlob]
        """
    ...
    def get_blob_client(
        ...
        :param snapshot:
            ...
            or a dictionary output returned by :func:`~azure.storage.blob.blob.BlobClient.create_snapshot()`.
