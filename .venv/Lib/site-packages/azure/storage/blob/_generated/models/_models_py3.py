...
class ArrowConfiguration(msrest.serialization.Model):
    ...
    :type schema: list[~azure.storage.blob.blob.models.ArrowField]
    """
...
class BlobFlatListSegment(msrest.serialization.Model):
    ...
    :type blob_items: list[~azure.storage.blob.blob.models.BlobItemInternal]
    """
...
class BlobHierarchyListSegment(msrest.serialization.Model):
    ...
    :param blob_prefixes:
    :type blob_prefixes: list[~azure.storage.blob.blob.models.BlobPrefix]
    :param blob_items: Required.
    :type blob_items: list[~azure.storage.blob.blob.models.BlobItemInternal]
    """
...
class BlobItemInternal(msrest.serialization.Model):
    ...
    :type properties: ~azure.storage.blob.blob.models.BlobPropertiesInternal
    :param metadata:
    :type metadata: ~azure.storage.blob.blob.models.BlobMetadata
    :param blob_tags: Blob tags.
    :type blob_tags: ~azure.storage.blob.blob.models.BlobTags
...
class BlobPropertiesInternal(msrest.serialization.Model):
    ...
    :type blob_type: str or ~azure.storage.blob.blob.models.BlobType
    :param lease_status:  Possible values include: "locked", "unlocked".
    :type lease_status: str or ~azure.storage.blob.blob.models.LeaseStatusType
    :param lease_state:  Possible values include: "available", "leased", "expired", "breaking",
     "broken".
    :type lease_state: str or ~azure.storage.blob.blob.models.LeaseStateType
    :param lease_duration:  Possible values include: "infinite", "fixed".
    :type lease_duration: str or ~azure.storage.blob.blob.models.LeaseDurationType
    :param copy_id:
    :type copy_id: str
    :param copy_status:  Possible values include: "pending", "success", "aborted", "failed".
    :type copy_status: str or ~azure.storage.blob.blob.models.CopyStatusType
    :param copy_source:
    ...
    :type access_tier: str or ~azure.storage.blob.blob.models.AccessTier
    ...
    :type archive_status: str or ~azure.storage.blob.blob.models.ArchiveStatus
    ...
    :type rehydrate_priority: str or ~azure.storage.blob.blob.models.RehydratePriority
    ...
    :type immutability_policy_mode: str or ~azure.storage.blob.blob.models.BlobImmutabilityPolicyMode
    :param legal_hold:
...
class BlobTags(msrest.serialization.Model):
    ...
    :type blob_tag_set: list[~azure.storage.blob.blob.models.BlobTag]
    """
...
class BlockList(msrest.serialization.Model):
    ...
    :type committed_blocks: list[~azure.storage.blob.blob.models.Block]
    :param uncommitted_blocks:
    :type uncommitted_blocks: list[~azure.storage.blob.blob.models.Block]
    """
...
class ContainerItem(msrest.serialization.Model):
    ...
    :type properties: ~azure.storage.blob.blob.models.ContainerProperties
...
class ContainerProperties(msrest.serialization.Model):
    ...
    :type public_access: str or ~azure.storage.blob.blob.models.PublicAccessType
...
class CpkInfo(msrest.serialization.Model):
    ...
    :type encryption_algorithm: str or ~azure.storage.blob.blob.models.EncryptionAlgorithmType
    """
...
class DataLakeStorageError(msrest.serialization.Model):
    ...
    :type data_lake_storage_error_details: ~azure.storage.blob.blob.models.DataLakeStorageErrorError
    """
...
class FilterBlobItem(msrest.serialization.Model):
    ...
    :type tags: ~azure.storage.blob.blob.models.BlobTags
    """
...
class FilterBlobSegment(msrest.serialization.Model):
    ...
    :type blobs: list[~azure.storage.blob.blob.models.FilterBlobItem]
    :param next_marker:
...
class GeoReplication(msrest.serialization.Model):
    ...
    :type status: str or ~azure.storage.blob.blob.models.GeoReplicationStatusType
...
class ListBlobsFlatSegmentResponse(msrest.serialization.Model):
    ...
    :type segment: ~azure.storage.blob.blob.models.BlobFlatListSegment
    :param next_marker:
    :type next_marker: str
    """
...
class ListBlobsHierarchySegmentResponse(msrest.serialization.Model):
    ...
    :type delimiter: str
    :param segment: Required.
    :type segment: ~azure.storage.blob.blob.models.BlobHierarchyListSegment
    :param next_marker:
    :type next_marker: str
    """
...
class ListContainersSegmentResponse(msrest.serialization.Model):
    ...
    :type container_items: list[~azure.storage.blob.blob.models.ContainerItem]
    :param next_marker:
    :type next_marker: str
    """
...
class Logging(msrest.serialization.Model):
    ...
    :type retention_policy: ~azure.storage.blob.blob.models.RetentionPolicy
    """
...
class PageList(msrest.serialization.Model):
    ...
    :param page_range:
    :type page_range: list[~azure.storage.blob.blob.models.PageRange]
    :param clear_range:
    :type clear_range: list[~azure.storage.blob.blob.models.ClearRange]
    """
...
class QueryFormat(msrest.serialization.Model):
    ...
    :param type: The quick query format type. Possible values include: "delimited", "json",
     "arrow", "parquet".
    :type type: str or ~azure.storage.blob.blob.models.QueryFormatType
    :param delimited_text_configuration: delimited text configuration.
    :type delimited_text_configuration: ~azure.storage.blob.blob.models.DelimitedTextConfiguration
    :param json_text_configuration: json text configuration.
    :type json_text_configuration: ~azure.storage.blob.blob.models.JsonTextConfiguration
    :param arrow_configuration: arrow configuration.
    :type arrow_configuration: ~azure.storage.blob.blob.models.ArrowConfiguration
...
class QueryRequest(msrest.serialization.Model):
    ...
    :type input_serialization: ~azure.storage.blob.blob.models.QuerySerialization
    :param output_serialization:
    :type output_serialization: ~azure.storage.blob.blob.models.QuerySerialization
    """
...
class QuerySerialization(msrest.serialization.Model):
    ...
    :type format: ~azure.storage.blob.blob.models.QueryFormat
    """
...
class SignedIdentifier(msrest.serialization.Model):
    ...
    :type access_policy: ~azure.storage.blob.blob.models.AccessPolicy
    """
...
class StorageServiceProperties(msrest.serialization.Model):
    ...
    :type logging: ~azure.storage.blob.blob.models.Logging
    :param hour_metrics: a summary of request statistics grouped by API in hour or minute
     aggregates for blobs.
    :type hour_metrics: ~azure.storage.blob.blob.models.Metrics
    :param minute_metrics: a summary of request statistics grouped by API in hour or minute
     aggregates for blobs.
    :type minute_metrics: ~azure.storage.blob.blob.models.Metrics
    :param cors: The set of CORS rules.
    :type cors: list[~azure.storage.blob.blob.models.CorsRule]
    ...
    :param delete_retention_policy: the retention policy which determines how long the associated
     data should persist.
    :type delete_retention_policy: ~azure.storage.blob.blob.models.RetentionPolicy
    :param static_website: The properties that enable an account to host a static website.
    :type static_website: ~azure.storage.blob.blob.models.StaticWebsite
    """
...
class StorageServiceStats(msrest.serialization.Model):
    ...
    :type geo_replication: ~azure.storage.blob.blob.models.GeoReplication
    """
