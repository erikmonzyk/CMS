...
class BlockBlobOperations(object):
    ...
    def commit_block_list(
        ...
        **kwargs  # type: Any
        ...
        :param blocks:
        :type blocks: ~azure.storage.blob.blob.models.BlockLookupList
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
         Timeouts for Blob Service Operations.</a>`.
    ...
    def get_block_list(
        ...
        **kwargs  # type: Any
        ...
        :type list_type: str or ~azure.storage.blob.blob.models.BlockListType
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
         Timeouts for Blob Service Operations.</a>`.
        ...
        :rtype: ~azure.storage.blob.blob.models.BlockList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
