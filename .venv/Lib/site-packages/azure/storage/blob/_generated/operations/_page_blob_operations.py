...
class PageBlobOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :type tier: str or ~azure.storage.blob.blob.models.PremiumPageBlobAccessTier
    ...
    def upload_pages(
        ...
        **kwargs  # type: Any
        ...
        :type sequence_number_access_conditions: ~azure.storage.blob.blob.models.SequenceNumberAccessConditions
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
    ...
    def get_page_ranges(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.storage.blob.blob.models.PageList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_sequence_number(
        ...
        **kwargs  # type: Any
        ...
        :type sequence_number_action: str or ~azure.storage.blob.blob.models.SequenceNumberActionType
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
         Timeouts for Blob Service Operations.</a>`.
