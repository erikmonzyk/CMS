...
class ContainerOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :param access: Specifies whether data in the container may be accessed publicly and the level
         of access.
        :type access: str or ~azure.storage.blob.blob.models.PublicAccessType
        :param request_id_parameter: Provides a client-generated, opaque value with a 1 KB character
         limit that is recorded in the analytics logs when storage analytics logging is enabled.
        :type request_id_parameter: str
        :param container_cpk_scope_info: Parameter group.
        :type container_cpk_scope_info: ~azure.storage.blob.blob.models.ContainerCpkScopeInfo
    ...
    def get_access_policy(
        ...
        **kwargs  # type: Any
        ...
        :rtype: list[~azure.storage.blob.blob.models.SignedIdentifier]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def set_access_policy(
        ...
        **kwargs  # type: Any
        ...
        :type container_acl: list[~azure.storage.blob.blob.models.SignedIdentifier]
        :param lease_access_conditions: Parameter group.
        :type lease_access_conditions: ~azure.storage.blob.blob.models.LeaseAccessConditions
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
    ...
    def list_blob_flat_segment(
        ...
        **kwargs  # type: Any
        ...
        :param include: Include this parameter to specify one or more datasets to include in the
         response.
        :type include: list[str or ~azure.storage.blob.blob.models.ListBlobsIncludeItem]
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
         Timeouts for Blob Service Operations.</a>`.
        ...
        :rtype: ~azure.storage.blob.blob.models.ListBlobsFlatSegmentResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_blob_hierarchy_segment(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.storage.blob.blob.models.ListBlobsHierarchySegmentResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
