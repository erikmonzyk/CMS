...
class BlobOperations:
    ...
    :type models: ~azure.storage.blob.blob.models
    ...
    async def download(
        ...
        **kwargs: Any
        ...
        :type lease_access_conditions: ~azure.storage.blob.blob.models.LeaseAccessConditions
        :param cpk_info: Parameter group.
        :type cpk_info: ~azure.storage.blob.blob.models.CpkInfo
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
    ...
    async def delete(
        ...
        **kwargs: Any
        ...
        :type delete_snapshots: str or ~azure.storage.blob.blob.models.DeleteSnapshotsOptionType
        :param request_id_parameter: Provides a client-generated, opaque value with a 1 KB character
         limit that is recorded in the analytics logs when storage analytics logging is enabled.
        :type request_id_parameter: str
    ...
    async def rename(
        ...
        **kwargs: Any
        ...
        :type path_rename_mode: str or ~azure.storage.blob.blob.models.PathRenameMode
        ...
        :type directory_http_headers: ~azure.storage.blob.blob.models.DirectoryHttpHeaders
        :param lease_access_conditions: Parameter group.
        :type lease_access_conditions: ~azure.storage.blob.blob.models.LeaseAccessConditions
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
        :param source_modified_access_conditions: Parameter group.
        :type source_modified_access_conditions: ~azure.storage.blob.blob.models.SourceModifiedAccessConditions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def set_expiry(
        ...
        **kwargs: Any
        ...
        :type expiry_options: str or ~azure.storage.blob.blob.models.BlobExpiryOptions
        :param timeout: The timeout parameter is expressed in seconds. For more information, see
         :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting
         Timeouts for Blob Service Operations.</a>`.
    ...
    async def set_http_headers(
        ...
        **kwargs: Any
        ...
        :type blob_http_headers: ~azure.storage.blob.blob.models.BlobHTTPHeaders
        :param lease_access_conditions: Parameter group.
        :type lease_access_conditions: ~azure.storage.blob.blob.models.LeaseAccessConditions
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
    ...
    async def set_metadata(
        ...
        **kwargs: Any
        ...
        :type cpk_scope_info: ~azure.storage.blob.blob.models.CpkScopeInfo
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.blob.models.ModifiedAccessConditions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
    ...
    async def start_copy_from_url(
        ...
        **kwargs: Any
        ...
        :type tier: str or ~azure.storage.blob.blob.models.AccessTierOptional
    ...
    async def set_tier(
        ...
        **kwargs: Any
        ...
        :type tier: str or ~azure.storage.blob.blob.models.AccessTierRequired
        :param snapshot: The snapshot parameter is an opaque DateTime value that, when present,
         specifies the blob snapshot to retrieve. For more information on working with blob snapshots,
         see :code:`<a
         href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/creating-a-snapshot-of-a-blob">Creating
    ...
    async def query(
        ...
        **kwargs: Any
        ...
        :type query_request: ~azure.storage.blob.blob.models.QueryRequest
        :param lease_access_conditions: Parameter group.
        :type lease_access_conditions: ~azure.storage.blob.blob.models.LeaseAccessConditions
        :param cpk_info: Parameter group.
        :type cpk_info: ~azure.storage.blob.blob.models.CpkInfo
    ...
    async def get_tags(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.storage.blob.blob.models.BlobTags
        :raises: ~azure.core.exceptions.HttpResponseError
        """
