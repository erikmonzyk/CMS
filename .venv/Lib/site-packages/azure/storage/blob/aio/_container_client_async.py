...
class ContainerClient(AsyncStorageAccountHostsMixin, ContainerClientBase):
    ...
    async def create_container(self, metadata=None, public_access=None, **kwargs):
        ...
        :param ~azure.storage.blob.blob.PublicAccess public_access:
        ...
        :paramtype container_encryption_scope: dict or ~azure.storage.blob.blob.ContainerEncryptionScope
        :keyword int timeout:
    ...
    async def get_container_properties(self, **kwargs):
        ...
        :rtype: ~azure.storage.blob.blob.ContainerProperties
    ...
    def _get_blob_service_client(self):  # pylint: disable=client-method-missing-kwargs
        ...
        :rtype: ~azure.storage.blob.blob.BlobServiceClient
    ...
    async def set_container_access_policy(
        ...
        :type signed_identifiers: dict[str, ~azure.storage.blob.blob.AccessPolicy]
        :param ~azure.storage.blob.blob.PublicAccess public_access:
            Possible values include: 'container', 'blob'.
        :keyword lease:
    ...
    def list_blobs(self, name_starts_with=None, include=None, **kwargs):
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.storage.blob.blob.BlobProperties]
    ...
    async def upload_blob(
        ...
        :type name: str or ~azure.storage.blob.blob.BlobProperties
        ...
        :rtype: ~azure.storage.blob.blob.aio.BlobClient
    ...
    async def delete_blob(
        ...
        :param blob: The blob with which to interact. If specified, this value will override
            a blob value specified in the blob URL.
        :type blob: str or ~azure.storage.blob.blob.BlobProperties
    ...
    async def delete_blobs(  # pylint: disable=arguments-differ
        ...
        :type blobs: list[str], list[dict], or list[~azure.storage.blob.blob.BlobProperties]
