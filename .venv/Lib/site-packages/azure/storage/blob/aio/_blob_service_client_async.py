...
class BlobServiceClient(AsyncStorageAccountHostsMixin, BlobServiceClientBase):
    ...
    async def get_user_delegation_key(self, key_start_time,  # type: datetime
        ...
        :rtype: ~azure.storage.blob.blob.UserDelegationKey
        """
    ...
    async def set_service_properties(
        ...
        :type analytics_logging: ~azure.storage.blob.blob.BlobAnalyticsLogging
        :param hour_metrics:
            The hour metrics settings provide a summary of request
            statistics grouped by API in hourly aggregates for blobs.
        :type hour_metrics: ~azure.storage.blob.blob.Metrics
        :param minute_metrics:
            The minute metrics settings provide request statistics
            for each minute for blobs.
        :type minute_metrics: ~azure.storage.blob.blob.Metrics
        :param cors:
            You can include up to five CorsRule elements in the
            list. If an empty list is specified, all CORS rules will be deleted,
            and CORS will be disabled for the service.
        :type cors: list[~azure.storage.blob.blob.CorsRule]
        ...
        :type delete_retention_policy: ~azure.storage.blob.blob.RetentionPolicy
        :param static_website:
            Specifies whether the static website feature is enabled,
            and if yes, indicates the index document and 404 error document to use.
        :type static_website: ~azure.storage.blob.blob.StaticWebsite
        :keyword int timeout:
            The timeout parameter is expressed in seconds.
        :rtype: None
    ...
    def list_containers(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.storage.blob.blob.ContainerProperties]
    ...
    def find_blobs_by_tags(self, filter_expression, **kwargs):
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.storage.blob.blob.FilteredBlob]
        """
    ...
    async def create_container(
        ...
        :type public_access: str or ~azure.storage.blob.blob.PublicAccess
        ...
        :keyword int timeout:
            The timeout parameter is expressed in seconds.
        :rtype: ~azure.storage.blob.blob.aio.ContainerClient
    ...
    async def delete_container(
        ...
        :type container: str or ~azure.storage.blob.blob.ContainerProperties
        :param lease:
    ...
    def get_blob_client(
        ...
        :param snapshot:
            ...
            :func:`~azure.storage.blob.blob.aio.BlobClient.create_snapshot()`.
