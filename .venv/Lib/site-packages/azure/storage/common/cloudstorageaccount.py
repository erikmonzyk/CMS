...
# ie. we don't want 'import azure.storage.blob' to trigger an automatic import
# of blob/queue/file packages.

from azure.storage.blob.common._error import _validate_not_none
from azure.storage.blob.common.models import (
    ResourceTypes,
    Services,
    AccountPermissions,
)
from azure.storage.blob.common.sharedaccesssignature import (
...
class CloudStorageAccount(object):
    ...
    def create_block_blob_service(self):
        '''
        Creates a BlobServiceClient object with the settings specified in the 
        CloudStorageAccount.

        :return: A service object.
        :rtype: :class:`~azure.storage.blob.blob.BlobServiceClient.BlobServiceClient`
        '''
        try:
            from azure.storage.blob.blob.BlobServiceClient import BlobServiceClient
            return BlobServiceClient(self.account_name, self.account_key,
    ...
    def create_page_blob_service(self):
        ...
        :return: A service object.
        :rtype: :class:`~azure.storage.blob.blob.pageblobservice.PageBlobService`
        '''
        try:
            from azure.storage.blob.blob.pageblobservice import PageBlobService
    ...
    def create_append_blob_service(self):
        ...
        :return: A service object.
        :rtype: :class:`~azure.storage.blob.blob.appendblobservice.AppendBlobService`
        '''
        try:
            from azure.storage.blob.blob.appendblobservice import AppendBlobService
    ...
    def create_queue_service(self):
        ...
        :return: A service object.
        :rtype: :class:`~azure.storage.blob.queue.queueservice.QueueService`
        '''
        try:
            from azure.storage.blob.queue.queueservice import QueueService
    ...
    def create_file_service(self):
        ...
        :return: A service object.
        :rtype: :class:`~azure.storage.blob.file.fileservice.FileService`
        '''
        try:
            from azure.storage.blob.file.fileservice import FileService
