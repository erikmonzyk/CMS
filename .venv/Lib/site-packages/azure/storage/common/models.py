...
class RetryContext(object):
    ...
    :ivar ~azure.storage.blob.common._http.HTTPRequest request:
        The request sent to the storage service.
    :ivar ~azure.storage.blob.common._http.HTTPResponse response:
...
class Services(object):
    ...
    def __init__(self, blob=False, queue=False, file=False, table=False, _str=None):
        '''
        :param bool blob:
            Access to any blob service, for example, the `.BlobServiceClient`
        :param bool queue:
